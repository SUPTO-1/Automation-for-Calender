...
public class calender {
    ...
    public static void main(String[] args) {
        // Setup ChromeDriver
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\DBLab1\\Downloads\\chromedriver-win64\\chromedriver-win64\\chromedriver.exe");
        ...
        try {
            ...
            calendarNameField.sendKeys("Supto");
